...
var d=E(`BP._dbg4('TOWLB-CAB-LG-LTBLU-R','UK')`);
console.log('meta:', JSON.stringify({q:d.q,i3:d.i3,if_:d.if_,l3:d.l3,exped:d.exped,disc:d.disc}));
console.log('keys:', (d.keys||[]).join(','));
(d.rows||[]).forEach(function(r){ console.log(r.key, JSON.stringify(r).slice(0,220)); });
