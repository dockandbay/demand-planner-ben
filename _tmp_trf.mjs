...
console.log('transfer header:', E(`(function(){ try{ if(!document.querySelector('.wrap')){var w2=document.createElement('div');w2.className='wrap';document.body.appendChild(w2);} if(!document.getElementById('main-hdr')){var t=document.createElement('table');var th=document.createElement('thead');th.id='main-hdr';t.appendChild(th);document.querySelector('.wrap').appendChild(t);} renderBuyView('transfer'); var h=document.getElementById('main-hdr').innerHTML; return 'hasBuy3PL='+(h.indexOf('Buy 3PL')>=0)+' hasBuyFBA='+(h.indexOf('Buy FBA')>=0)+' hasTrfh='+(h.indexOf('trfh1')>=0)+' hasSOH3PL='+(h.indexOf('SOH 3PL')>=0); }catch(e){ return 'ERR:'+e.message; } })()`));
console.log('buy header (compare):', E(`(function(){ renderBuyView('buy'); var h=document.getElementById('main-hdr').innerHTML; return 'hasBuy3PL='+(h.indexOf('Buy 3PL')>=0)+' hasBuyFBA='+(h.indexOf('Buy FBA')>=0); })()`));
