...
console.log('ACTIONS:', E(`(function(){ try{ if(!document.querySelector('.wrap')){var w2=document.createElement('div');w2.className='wrap';document.body.appendChild(w2);} renderBuyMoveActions(); var wr=document.getElementById('bm-actions-wrap'); return wr?('rows='+wr.querySelectorAll('.bma-row').length+' buy3pl='+(wr.innerHTML.indexOf('Buy 3PL')>=0)+' fbaTrf='+(wr.innerHTML.indexOf('FBA Transfer')>=0)):'no-wrap'; }catch(e){ return 'ERR:'+e.message; } })()`));
console.log('BUY no trf:', E(`(function(){ if(!document.getElementById('main-hdr')){var t=document.createElement('table');var th=document.createElement('thead');th.id='main-hdr';t.appendChild(th);document.querySelector('.wrap').appendChild(t);} renderBuyView('buy'); var h=document.getElementById('main-hdr').innerHTML; return 'trfh='+(h.indexOf('trfh1')>=0)+' Buy3PL='+(h.indexOf('Buy 3PL')>=0)+' UrgSea='+(h.indexOf('Urgent<br>Sea')>=0); })()`));
