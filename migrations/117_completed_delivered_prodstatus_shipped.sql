...
-- to every PO whose status is SHIPPED / SHIPPING / COMPLETE(D) / DELIVERED. If it has shipped,
...
-- NOTE: 'ship%' (not '%ship%') so we do NOT catch "READY TO SHIP" — that is a pre-ship status.
